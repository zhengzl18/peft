...
TRANSFORMERS_MODELS_TO_XXX_TARGET_MODULES_MAPPING = TRANSFORMERS_MODELS_TO_LORA_TARGET_MODULES_MAPPING.copy()
TRANSFORMERS_MODELS_TO_XXX_TARGET_MODULES_MAPPING["gpt_bigcode"] = ["mlp.c_proj"]
TRANSFORMERS_MODELS_TO_XXX_TARGET_MODULES_MAPPING["gpt2"] = ["mlp.c_proj"]
